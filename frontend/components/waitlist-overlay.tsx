      ...
      <div className="relative w-full max-w-md rounded-2xl border border-white/10 bg-white/5 backdrop-blur-md p-8 shadow-2xl">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-sm text-muted-foreground">
            Be the first to trade stocks and crypto by chatting.
          </p>
        </div>

        {/* Section 1: Email signup */}
        {submitState === "success" ? (
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center">
            <span className="bg-transparent px-3 text-xs text-muted-foreground">or join the community</span>
          </div>
        </div>
