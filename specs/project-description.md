...
- **OpenAI function calling** — the LLM parses natural language into structured trade intents, not regex or keyword matching
...
User speaks or types
      |
      v
AI agent (OpenAI GPT-4o-mini, streaming)
      |
      +--> Parses intent via function calling
...
| **Backend** | Python 3.12 + FastAPI | Async, fast, OpenAI SDK native |
| **AI** | OpenAI GPT-4o-mini (function calling) | Best trade-off of speed, cost, and tool use |
